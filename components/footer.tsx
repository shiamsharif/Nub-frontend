...
export function Footer() {
  return (
    <motion.footer
      ...
      className="relative bg-gradient-to-br from-blue-700 to-purple-700 text-white py-12 overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="font-extrabold text-2xl text-white drop-shadow-md">NUB IT Support</span>
            </div>
            <p className="text-gray-200 mb-4 max-w-md leading-relaxed">
              Making IT support a breeze for Northern University Bangladesh. We're here to help you thrive!
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-200">
              ...
              <li>
                <Link href="/blog" className="hover:text-white transition-colors hover:underline">
                  Our Blog
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-200">
              <li>
                <a href="mailto:it-support@nub.ac.bd" className="hover:text-white transition-colors hover:underline">
                  it-support@nub.ac.bd
                </a>
              </li>
              <li>
                <a href="tel:+88028833388" className="hover:text-white transition-colors hover:underline">
                  +880-2-8833388
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-white/20 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center text-gray-300">
          <p className="text-sm flex items-center gap-1">
            Made with <Heart className="w-4 h-4 text-red-400 animate-pulse" /> for NUB IT Support © 2024
          </p>
