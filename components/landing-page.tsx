  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <motion.section
        ...
        className="relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-blue-50 py-24 md:py-32"
      >
                ...
                <Card className="text-center hover:shadow-lg transition-shadow duration-300">
                  <CardContent className="pt-6">
                    <img
                      ...
                      className="w-24 h-24 rounded-full mx-auto mb-4 object-cover border-4 border-blue-100 shadow-md"
                    />
