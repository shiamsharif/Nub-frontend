...
export function UserDashboard() {
    ...
    const mockTasks: Task[] = [
      {
        ...
        description: "Students are unable to connect to the internet in Computer Lab 1",
        status: "pending",
        priority: "high",
      ...
      },
      {
        ...
        description: "The HP LaserJet printer in Office 205 is showing error messages",
        status: "in-progress",
        priority: "medium",
      ...
      },
      {
        ...
        description: "Need to install Adobe Creative Suite on 10 computers in Design Lab",
        status: "resolved",
        priority: "low",
  ...
  if (user?.role === "ITStaff") {
    return <AdminDashboard tasks={tasks} onUpdateTask={handleUpdateTask} onDeleteTask={handleDeleteTask} />
  }
        ...
        <div className="px-4 py-6 sm:px-0">
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="mt-2 text-gray-600">Manage and track your IT support requests</p>
            </div>
